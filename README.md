...
- In Go iterfaces are satisfied implicity
- simple and short
...
[fprintf](https://pkg.go.dev/fmt#example-Fprintf)
...
- Automatic
- Expression assigned only if iterface satisfied
- Wraps concrete type

### Type assertions

- v := x.(T) -> panic on error
- v, ok := x.(T) -> returns boolean and zero value
...
func main() {
	...
	shapes := []Shape{circle{1.0}, triangle{1, 2, 3}, rectangle{2, 3}}
